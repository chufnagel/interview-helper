...
exports.register = function (server, options, next) {
  let interviewTemplatesStore,
    interviewQuestionsStore;
  let ObjectID;

  server.dependency('hapi-mongodb', (depServer, after) => {
    interviewTemplatesStore = depServer.plugins['hapi-mongodb'].db.collection('interview-templates');
    interviewQuestionsStore = depServer.plugins['hapi-mongodb'].db.collection('interview-questions');
